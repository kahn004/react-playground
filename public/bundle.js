...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsDevActions = __webpack_require__(161);

	var _actionsDevActions2 = _interopRequireDefault(_actionsDevActions);

	var _storesDevStore = __webpack_require__(175);

	var _storesDevStore2 = _interopRequireDefault(_storesDevStore);
	...
	var App = (function (_React$Component) {
		function App(props) {
			...
			this.state = _storesDevStore2['default'].getState();
		}
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				_storesDevStore2['default'].listen(this.storeChanged);
			}
		}, {
			key: 'componentWillUnmount',
			value: function componentWillUnmount() {
				_storesDevStore2['default'].unlisten(this.storeChanged);
			}
		}, {
			key: 'storeChanged',
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'button',
						{ className: 'add-dev', onClick: this.addDev, style: { margin: 20 + 'px' } },
						'Add a developer'
					)
				);
			}
			...
			key: 'addDev',
			value: function addDev() {
				_actionsDevActions2['default'].create({ name: 'Click to name a dev' });
			}
		}, {
			key: 'editDev',
			value: function editDev(devId, name) {
				_actionsDevActions2['default'].update({ devId: devId, name: name });
			}
		}, {
			key: 'deleteDev',
			value: function deleteDev(devId) {
				_actionsDevActions2['default']['delete'](devId);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dev = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// app/actions/DevActions.js

	var _libsAlt = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DevStore = (function () {
		function DevStore() {
			_classCallCheck(this, DevStore);

			this.bindActions(_actionsDevActions2['default']);
		...
		_createClass(DevStore, [{
			key: 'create',
			value: function create(dev) {
				var devs = this.devs;

				dev.id = _nodeUuid2['default'].v4();
	...
	exports['default'] = _libsAlt2['default'].createStore(DevStore, 'DevStore');
	module.exports = exports['default'];
